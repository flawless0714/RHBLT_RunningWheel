...
SI_SBIT (CLIF0_C0FIF, SFR_CLIF0, 0); ///< CLU0 Falling Edge Interrupt Flag
SI_SBIT (CLIF0_C0RIF, SFR_CLIF0, 1); ///< CLU0 Rising Edge Interrupt Flag 
SI_SBIT (CLIF0_C1FIF, SFR_CLIF0, 2); ///< CLU1 Falling Edge Interrupt Flag
SI_SBIT (CLIF0_C1RIF, SFR_CLIF0, 3); ///< CLU1 Rising Edge Interrupt Flag 
SI_SBIT (CLIF0_C2FIF, SFR_CLIF0, 4); ///< CLU2 Falling Edge Interrupt Flag
SI_SBIT (CLIF0_C2RIF, SFR_CLIF0, 5); ///< CLU2 Rising Edge Interrupt Flag 
SI_SBIT (CLIF0_C3FIF, SFR_CLIF0, 6); ///< CLU3 Falling Edge Interrupt Flag
SI_SBIT (CLIF0_C3RIF, SFR_CLIF0, 7); ///< CLU3 Rising Edge Interrupt Flag 
